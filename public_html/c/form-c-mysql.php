...
<head>
    ...
    <script src="../scripts/form-c-process.js"></script>
    <link href="../styles/form.css" rel="stylesheet">
    <title>Form Submission (C) - MySQL</title>
</head>
<body>
    ...
    <h2 class="center">Form Submission (C) - MySQL</h2>
    <h3 class="center">JavaScript | URL-encoded form data | <code>XMLHttpRequest</code> object | HTML-formatted text string response</h3>
...
<a href="https://github.com/tech-otaku/forms" target="_blank">forms</a>
  ...
  |-- <a href="https://github.com/tech-otaku/forms/blob/master/mysql-credentials.ini.template" target="_blank">mysql-credentials.ini</a>
    ...
    <div id="data-returned">
        <!-- Populated by JavaScript code (../scripts/form-c-process.js) on successful response from server or when server cannot be contacted -->
    </div>
