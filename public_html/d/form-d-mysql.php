...
<head>
    ...
    <script src="../scripts/form-d-process.js"></script>
    <link href="../styles/form.css" rel="stylesheet">
    <title>Form Submission (D) - MySQL</title>
</head>
<body>
    ...
    <h2 class="center">Form Submission (D) - MySQL</h2>
    <h3 class="center">JavaScript | <code>FormData</code> object | <code>XMLHttpRequest</code> object | JSON-encoded string response</h3>
...
<a href="https://github.com/tech-otaku/forms" target="_blank">forms</a>
  |-- public_html/
      |-- d/
          |-- <a href="https://github.com/tech-otaku/forms/blob/master/public_html/d/form-d-mysql.php" target="_blank">form-d-mysql.php</a>  
      |-- scripts/
          |-- <a href="https://github.com/tech-otaku/forms/blob/master/public_html/scripts/form-d-process.js" target="_blank">form-d-process.js</a>  
      |-- styles/
  ...
  |-- <a href="https://github.com/tech-otaku/forms/blob/master/mysql-credentials.ini.template" target="_blank">mysql-credentials.ini</a>
    ...
    <div id="data-returned">
        <!-- Populated by JavaScript code (../scripts/form-d-process.js) on successful response from server or when server cannot be contacted -->
    </div>
