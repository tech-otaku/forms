...
<head>
    ...
    <script src="../scripts/form-g-process.js"></script>
    <link href="../styles/form.css" rel="stylesheet">
    <title>Form Submission (G) - MySQL</title>
</head>
<body>
    ...
    <h2 class="center">Form Submission (G) - MySQL</h2>
    <h3 class="center">jQuery | <code>FormData</code> object | <code>$.ajax()</code> method using methods <code>done()</code> and <code>fail()</code> | HTML-formatted text string response</h3>
...
<a href="https://github.com/tech-otaku/forms" target="_blank">forms</a>
  |-- public_html/
      |-- g/
          |-- <a href="https://github.com/tech-otaku/forms/blob/master/public_html/g/form-g-mysql.php" target="_blank">form-g-mysql.php</a>  
      |-- scripts/
          |-- <a href="https://github.com/tech-otaku/forms/blob/master/public_html/scripts/form-g-process.js" target="_blank">form-g-process.js</a>  
      |-- styles/
  ...
  |-- <a href="https://github.com/tech-otaku/forms/blob/master/mysql-credentials.ini.template" target="_blank">mysql-credentials.ini</a>
    ...
    <div id="data-returned">
        <!-- Populated by JavaScript code (../scripts/form-g-process.js) on successful response from server or when server cannot be contacted -->
    </div>
