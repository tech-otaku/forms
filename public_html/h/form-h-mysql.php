...
<head>
    ...
    <script src="../scripts/form-h-process.js"></script>
    <link href="../styles/form.css" rel="stylesheet">
    <title>Form Submission (H) - MySQL</title>
</head>
<body>
    ...
    <h2 class="center">Form Submission (H) - MySQL</h2>
    <h3 class="center">JavaScript | <code>FormData</code> object | <code>fetch()</code> method using <code>then()</code> methods | JSON-encoded string response</h3>
...
<a href="https://github.com/tech-otaku/forms" target="_blank">forms</a>
  |-- public_html/
      |-- g/
          |-- <a href="https://github.com/tech-otaku/forms/blob/main/public_html/h/form-h-mysql.php" target="_blank">form-h-mysql.php</a>  
      |-- scripts/
          |-- <a href="https://github.com/tech-otaku/forms/blob/main/public_html/scripts/form-h-process.js" target="_blank">form-h-process.js</a>  
      |-- styles/
  ...
  |-- <a href="https://github.com/tech-otaku/forms/blob/main/mysql-credentials.ini.template" target="_blank">mysql-credentials.ini</a>
    ...
    <div id="data-returned">
        <!-- Populated by JavaScript code (../scripts/form-h-process.js) on successful response from server or when server cannot be contacted -->
    </div>
